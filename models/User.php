...
class User extends \yii\db\ActiveRecord implements \yii\web\IdentityInterface
{
    ...
    const ROLE_STAFF = 50;// role will be staff
    const ROLE_ADMIN = 1; // role will be admin
    const STATUS_DELETED = -1; // once admin delete user
    const STATUS_DISABLED = 0; // once admin change the status to disabled
    const STATUS_PENDING = 1;//once user register
    const STATUS_ACTIVE = 10; //approve
    /**
    ...
    public static function findByUsernameWithRoles($username, $roles)
    {
        ...
        // $user = static::find()->all();
//         foreach($user as $dataval){
//             echo "<br>";
//             echo $dataval->id." ".$dataval->username."<br>";
//         }
//   exit;
